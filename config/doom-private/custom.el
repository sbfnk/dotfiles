(custom-set-variables
 ...
 '(ignored-local-variable-values
   '((org-reveal-title-slide
      . "<h1>%t</h1><br><h4>%a<br>%d<br>University of Glasgow</h4><img src='images/LSHTM_Logo_Black.png' height=130> <img src='images/logo.png'>")
     (TeX-engine . xetex)))
 ...
 '(safe-local-variable-values
   '((org-reveal-title-slide
      . "<h1>%t</h1><br><h4>%a<br>%d<br>recon gathering, London</h4><img src='images/LSHTM_Logo_Black.png' height=130> <img src='images/logo.png'>")))
