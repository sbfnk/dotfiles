...
* Email
Email configuration is in a separate file (in doom-private, generated from accounts.yaml).
The =t= flag makes this a no-op when doom-private is absent (e.g., on a fork).
#+begin_src emacs-lisp
